...
*proyecto:Pelota Tipico
*Funcionalidad: Crea una pelota en el area cliente
*Metodos: KillTimer
*Handles:
*Mensages:
*Tipo:
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	RECT rt;
	static int xPos = 100, yPos = 56, dir = 0;
	...
	switch (message) 
	{
		...
		case WM_TIMER:
			if(band)
			{
				switch(dir)
				{
					case 0: //Direccion Derecho Arriba
					...
					break;
					case 1:  //Direccion Derecho Abajo
						if(xPos+100 <= rt.right)
							xPos+=PASO;
						else
						{
					...
					break;
					case 2:  //Direccion Izquierdo Abajo
						if(xPos >= rt.left)
							xPos-=PASO;
						else
						{
					...
					break;
					case 3://Direccion Izquierdo Arriba
						if(xPos >= rt.left)
							xPos-=PASO;
						else
						{
